...
## 📌Summary
End-to-end analysis of bank loan data using SQL and Power BI to evaluate loan performance, risk, and key business KPIs.
## 📊 Overview
This project analyzes bank loan data to understand lending patterns, borrower behavior, and loan performance.
Using MS SQL Server for data analysis and Power BI for visualization, the project provides actionable insights to support better lending and risk management decisions.
## ❓ Problem Statement
Banks need a clear view of:
...
- Loan applications follow clear monthly trends
- Borrowers with lower DTI ratios show better repayment behavior
- Regional differences exist in loan distribution and performance
## 📊 Dashboard
